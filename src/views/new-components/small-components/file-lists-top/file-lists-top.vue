...
<template>
  <div class="list-top">
    <ul>
      ...
      <li @click="exportsExcel.exportExcel = !exportsExcel.exportExcel;"><Icon size="14" type="share"></Icon><span>导出</span></li>
      ...
      <div class="searchBox">
        ...
        <div class="rows">
          ...
          <div class="r">
            ...
            <div class="in">
              <Select v-model="searchFields.contractType" style="width:190px">
        ...
        <div class="rows">
          ...
          <div class="r">
            ...
            <div class="in">
              <DatePicker type="daterange" v-model="searchFields.effectiveDate" placement="bottom-end" placeholder="Select date" style="width: 190px"></DatePicker>
            </div>
          </div>
        </div>  
...
export default {
  ...
  methods: {
    ...
    reset () {
      ...
      this.searchFields.groupCompany = '1';
      this.searchFields.businessBrief = '';
      this.searchFields.contractNo = '';
      this.searchFields.oppositeCompany = '';
      this.searchFields.effectiveDate = '';
      this.enteringDate = '';
      this.situation = '0';
      this.searchFields.status = '0';
      this.searchFields.contractType = '0';
    },
    //手动上传
    handleUpload (file) {
       console.log(file);
